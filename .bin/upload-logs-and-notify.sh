...
# copy report files
cp ${TRAVIS_BUILD_DIR}/shopsystems-ui-testsuite/tests/_output/*.html ${REPO_NAME}/${RELATIVE_REPORTS_LOCATION}
cp ${TRAVIS_BUILD_DIR}/shopsystems-ui-testsuite/tests/_output/*.xml ${REPO_NAME}/${RELATIVE_REPORTS_LOCATION}
if [[ $1 == 'fail' ]]; then
    cp ${TRAVIS_BUILD_DIR}/shopsystems-ui-testsuite/tests/_output/*.fail.png ${REPO_NAME}/${RELATIVE_REPORTS_LOCATION}
fi
